...
class TownStages {
  ...
  static const List<TownStage> stages = [
    TownStage(id: 'empty', name: '何もない地平線', minLevel: 0),
    TownStage(id: 'lightbulb', name: '豆電球がつく', icon: Icons.lightbulb, minLevel: 1),
    TownStage(id: 'lamp', name: '電灯がつく', icon: Icons.wb_incandescent, minLevel: 2),
    TownStage(id: 'house_lights', name: '家の明かりが付く', icon: Icons.house, minLevel: 4),
    TownStage(id: 'factory', name: '工場が稼働する', icon: Icons.factory, minLevel: 7),
    TownStage(id: 'town', name: '街が広がる', icon: Icons.holiday_village, minLevel: 10),
    TownStage(id: 'city', name: '都市になる', icon: Icons.apartment, minLevel: 13),
    TownStage(id: 'rocket', name: 'ロケット建設する', icon: Icons.rocket_launch, minLevel: 17),
  ];
  ...
  static List<TownStage> reachedStages(int level) =>
