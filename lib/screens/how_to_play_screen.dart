        ...
        children: [
          _SectionCard(
            ...
            children: const [
              ...
              _Step(number: 3, text: '星画面でストックした電池を「投入」すると、星に灯りが広がります。'),
              _Step(number: 4, text: '投入するたびに発展度が上がり、夜の星の街明かりが増えていきます。'),
            ],
          ),
          _SectionCard(
            icon: Icons.bolt,
          ...
          _SectionCard(
            ...
            children: const [
              ...
              SizedBox(height: 8),
              Text('1回の投入で発展度が +1 され、夜の星の灯りが進みます。種類の選択はありません。'),
            ],
          ),
          _SectionCard(
            icon: Icons.public,
            ...
            children: const [
              ...
              SizedBox(height: 8),
              Text('発展度が上がるほど星にともる街明かりが増え、最終ステージに到達すると星全体が輝きます。'),
              SizedBox(height: 8),
              Text('最終ステージ到達後もさらに投入を続けると、一定回数ごとに「完成した星」が1個ずつ積み上がっていきます。'),
              SizedBox(height: 8),
              Text('星が1個完成するたびに、星の灯りは一度真っ暗にリセットされ、次の星へ向けてまた灯りが広がっていきます。'),
            ],
          ),
          _SectionCard(
            ...
            children: const [
              ...
              _Bullet(text: '星 — 夜の星の灯り・発展度・電池の投入'),
          ...
          _SectionCard(
            ...
            title: 'ヒント',
            children: const [
              _Bullet(text: '電池が溜まったら星画面で「投入」すると星に灯りが広がります。'),
              _Bullet(text: '星を左右にドラッグすると回せます。'),
